...
class _SplashScreenState extends State<HomePage2> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: LoginTestPage()));
      }
    });
  }
        ...
        child: Stack(
          children: <Widget>[
            Positioned(
              top: -50,
              left: 0,
              child: FadeAnimationScreen(1, Container(
                width: width,
                height: 400,
            ...
            Positioned(
              top: -100,
              left: 0,
              child: FadeAnimationScreen(1.3, Container(
                width: width,
                height: 400,
                decoration: BoxDecoration(
                    image: DecorationImage(
            ...
            Positioned(
              top: -150,
              left: 0,
              child: FadeAnimationScreen(1.6, Container(
                width: width,
                height: 400,
                decoration: BoxDecoration(
                    image: DecorationImage(
